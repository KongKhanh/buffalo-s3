                            ...
                            <form method="POST" action="" enctype="multipart/form-data">
                                <div class="row g-2">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="post_title" id="post_title" placeholder="Nhập tên tiêu đề" data-last-news-id="<?= $lastInforId ?>">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select id="post_menu_id" class="form-select" name="post_menu_id">
                                            ...
                                            <?php 
                                                foreach($inforCate as $inforItem) {
                                                    if($inforItem['mc_status'] == 'published') {
                                                        echo <<<HTML
                                ...
                                <div class="row g-2">
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <textarea type="text" name="post_content" class="form-control" id="contenteditor"></textarea>
                                    </div>
                                </div>
