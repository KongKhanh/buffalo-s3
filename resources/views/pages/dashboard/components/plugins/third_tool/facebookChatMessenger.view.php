                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="form-row-preview">
                            <form method="POST" action="/dashboard/tool-third/update/by-switch-case">
                                ...
                                <input type="hidden" value="<?= $FacebookChatMessengerCode['tt_type']; ?>" name="tt_type">

                                <div class="row g-2">
                                    <div class="mb-3 col-md-12">
                                        <label for="tt_code" class="form-label">Code embed - <?= $FacebookChatMessengerCode['tt_title']; ?></label>
                                        <textarea 
                                            type="text" 
                                            name="tt_code" 
                                            class="form-control" 
                                        ...
                                        >
                                            <?= 
                                                $FacebookChatMessengerCode['tt_code'];
                                            ?>
                                        </textarea>
                                    </div>
                                </div>
