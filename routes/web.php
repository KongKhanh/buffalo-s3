 ...
 * Ui Background
 */
$router->get('/dashboard/ui-background/{id}', [UiBackground::class, '__getBackgroundForm'])->middleware('auth');

$router->post('/dashboard/ui-background/update/{id}', [UiBackground::class, '__updateBackground'])->middleware('auth');
